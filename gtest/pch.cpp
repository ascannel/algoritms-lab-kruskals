...
std::vector<Edge> generateRandomGraph(int numVertices, int numEdges, int minWeight, int maxWeight) {
    ...
    std::set<std::pair<int, int>> edgeSet; // дл€ проверки уникальности рЄбер
    ...
    // —оздание св€зного графа, добавл€€ рЄбра между последовательными вершинами 
    ...
    // добавление случайных рЄбер дл€ достижени€ нужного количества 
